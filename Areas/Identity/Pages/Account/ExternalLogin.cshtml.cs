...
namespace AcquaJrApplication.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (remoteError != null)
            {
                ErrorMessage = $"Ocorreu um erro do provedor externo: {remoteError}";
                return RedirectToPage("./Login", new {ReturnUrl = returnUrl });
            }
            var info = await _signInManager.GetExternalLoginInfoAsync();
            if (info == null)
            {
                ErrorMessage = "Ocorreu um erro ao carregar informações de login externas.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Ocorreu um erro ao carregar informações de login externas durante a confirmação.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
