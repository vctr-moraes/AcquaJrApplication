...
namespace AcquaJrApplication.Areas.Identity.Pages.Account.Manage
{
    public class Disable2faModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            {
                throw new InvalidOperationException($"Não é possível desativar o 2FA para o usuário com ID '{_userManager.GetUserId(User)}' já que não está ativado no momento.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "2FA foi desativado. Você pode ativar o 2FA ao configurar um aplicativo autenticador";
